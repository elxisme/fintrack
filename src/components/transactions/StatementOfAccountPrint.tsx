    ...
    <>
      ...
      <div className="print-modal-content max-w-4xl mx-auto bg-white text-black">
        ...
        <div className="text-center mb-3 border-b-2 border-gray-800 pb-3">
          ...
          <h2 className="text-base font-semibold mb-2">STATEMENT OF ACCOUNT</h2>
        ...
        <div className="mb-3">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-blue-100 border-2 border-blue-400 p-3 text-center">
              <h3 className="text-base font-bold text-blue-800">TOT. BALANCE: {formatCurrency(totalBalance)}</h3>
            </div>
            <div className={`text-center p-3 border-2 ${netIncome >= 0 ? 'bg-green-100 border-green-400' : 'bg-red-100 border-red-400'}`}>
              <h3 className={`text-base font-bold ${netIncome >= 0 ? 'text-green-800' : 'text-red-800'}`}>
          ...
          <div className="grid grid-cols-2 gap-4 mt-2">
            <div className="bg-green-100 border-2 border-green-400 p-3 text-center">
              <h3 className="text-base font-bold text-green-800">TOTAL INCOME: {formatCurrency(totalIncome)}</h3>
            </div>
            <div className="bg-red-100 border-2 border-red-400 p-3 text-center">
              <h3 className="text-base font-bold text-red-800">TOTAL EXPENSES: {formatCurrency(totalExpenses)}</h3>
            </div>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="mt-3 pt-1 border-t border-gray-400 text-center text-xs text-gray-600">
