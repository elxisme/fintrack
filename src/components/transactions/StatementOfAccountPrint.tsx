  ...
  return (
    <>
      ...
      <div className="print-modal-content max-w-4xl mx-auto p-8 bg-white text-black">
        {/* Header */}
        <div className="text-center mb-8 border-b-2 border-gray-800 pb-6 avoid-break">
        ...
        {/* Page break before detailed transactions */}
        ...
        {/* Footer */}
        <div className="mt-8 pt-4 border-t border-gray-400 text-center text-sm text-gray-600 avoid-break">
