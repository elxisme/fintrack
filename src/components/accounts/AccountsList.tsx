    ...
    <div className="p-4 sm:p-6 bg-gray-50 dark:bg-gray-950 transition-colors duration-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base">Manage your financial accounts</p>
        </div>
        <button
      ...
      {accounts.length > 0 ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6 text-sm sm:text-base">Create your first account to start tracking your finances</p>
          <button
            onClick={() => setShowCreateModal(true)}
